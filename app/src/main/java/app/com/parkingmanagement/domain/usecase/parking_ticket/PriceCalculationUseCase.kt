 ...
 */
class PriceCalculationUseCase @Inject constructor(private val repository: ParkingTicketRepository) :
    SingleUseCase<ParkingTicket>() {

    override fun buildUseCaseSingle(obj: Any?): Single<ParkingTicket> {
        return repository.calculatePrice(obj as PriceCalculation)
    }
