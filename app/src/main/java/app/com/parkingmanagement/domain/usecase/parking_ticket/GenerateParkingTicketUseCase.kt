 ...
 */
class GenerateParkingTicketUseCase @Inject constructor(private val repository: ParkingTicketRepository) :
    SingleUseCase<ParkingTicket>() {

    override fun buildUseCaseSingle(obj: Any?): Single<ParkingTicket> {
        return repository.generateTicket(obj as GenerateTicket)
    }
}